            ...
            while (i < pathComps.length) {
                ...
                while (true) {
                    ...
                    if (!existed) {
                        ...
                        t.setImage(new Image(table.getDisplay(), new ByteArrayInputStream(Utils.getResourceData("folder.png"))));
                        t.setText(comp);
                        currentNode = t;
                    }
                        ...
                        try {
                            ...
                            for (i = 0; i < objArr.length(); ++i) {
                                ...
                                if (type.equals("directory")) {
                                    item.setImage(0, new Image(table.getDisplay(), new ByteArrayInputStream(Utils.getResourceData("folder.png"))));
                                } else {
                                    item.setImage(0, new Image(table.getDisplay(), new ByteArrayInputStream(Utils.getResourceData("file.png"))));
                                }
