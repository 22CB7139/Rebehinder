...
public class MainShell extends Shell {
    ...
    public MainShell(Display display, final JSONObject shellEntity) {
        ...
        try {
            Image startImage = new Image(display, new ByteArrayInputStream(Utils.getResourceData("start.png")));
            realCmdBtn.setData("start", startImage);
            Image stopImage = new Image(display, new ByteArrayInputStream(Utils.getResourceData("stop.png")));
        ...
        try {
            Image reverseImage = new Image(display, new ByteArrayInputStream(Utils.getResourceData("reverse.png")));
