                        ...
                        if (!DBManagerUtils.this.statusLabel.isDisposed()) {
                            try {
                                ...
                                for (int i = 1; i <= databaseNums; ++i) {
                                    ...
                                    t.setImage(new Image(table.getDisplay(), new ByteArrayInputStream(Utils.getResourceData("database.png"))));
                            ...
                            if (!DBManagerUtils.this.statusLabel.isDisposed()) {
                                try {
                                    ...
                                    for (int i = 1; i <= tableNums; ++i) {
                                        ...
                                        t.setImage(new Image(table.getDisplay(), new ByteArrayInputStream(Utils.getResourceData("database_table.png"))));
                                        t.setText(row.get(0).toString());
                                    }
    ...
    public void showColumns(String url, TreeItem currentNode, Table table) {
        try {
            ...
            for (int i = 1; i <= tableNums; ++i) {
                ...
                t.setImage(new Image(table.getDisplay(), new ByteArrayInputStream(Utils.getResourceData("database_column.png"))));
                t.setText(row.get(0).toString());
            }
